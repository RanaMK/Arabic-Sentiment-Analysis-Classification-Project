...
#    from keras.regularizers import l2
    ...
    embedding_layer = Embedding(max_features, embeddings_dim, input_length=max_sent_len, mask_zero=False, weights=[embedding_weights] )(main_input)
#    Drop1 = Dropout(dropout_prob[0])(embedding)
    ...
    Merged = Concatenate()(conv_pools)
    lstm_lay = LSTM(100)(Merged)
    #    flat = Flatten()(Merged)
    dense = Dense(100, activation='relu')(lstm_lay)
    if num_classes ==2:
...
#    print(model.summary())
    ...
    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot_cnn_lstm.png', show_shapes=True, show_layer_names=True)

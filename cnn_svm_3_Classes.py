...
#    layer_name = 'Dense_final'
    layer_name = 'Out'
#    model_output = Model(inputs=model.input, outputs=model.get_output_at(-1)).
    ###########################   SVM ##############################--Code from course
    # Fitting SVM to the Training set 
    model_feat = Model(inputs=model.input, outputs=model.get_output_at(-1))
...
#model_feat = Model(inputs=model.input,outputs=model.get_layer('merge_1').output)
#
#feat_train = model_feat.predict(train_sequences)
#print(feat_train.shape)
#

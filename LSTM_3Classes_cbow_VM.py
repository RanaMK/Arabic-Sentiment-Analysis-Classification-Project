...
#version2
#embeddings = gensim.models.Word2Vec.load('C:\\Users\\paperspace\\Desktop\\Twt-CBOW\\v2\\tweets_cbow_300')
...
#    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot.png', show_shapes=True, show_layer_names=True)
    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot_LSTM_1.png', show_shapes=True, show_layer_names=True)
...
#    early_stopping = EarlyStopping(patience=20, verbose=1)
    ...
    checkpointer = ModelCheckpoint(filepath= 'C:\\Users\\paperspace\\Desktop\\Results\\Weights\\'+dataset_name+'_'+Round+'_'+Linked+'_''_'+Vectors+'_weights_Ar_best.hdf5', verbose=1, save_best_only=False)
#    checkpointer = ModelCheckpoint(filepath= 'C:\\Users\\paperspace\\Desktop\\Results\\Weights\\'+dataset_name+'_'+Round+'_'+Linked+'_''_'+Vectors+'_weights_Ar_best.csv', verbose=1, save_best_only=False)
...
#    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot.png', show_shapes=True, show_layer_names=True)
    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot_LSTM_2.png', show_shapes=True, show_layer_names=True)
...
#    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot.png', show_shapes=True, show_layer_names=True)
    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot_LSTM_3.png', show_shapes=True, show_layer_names=True)
...
#    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot.png', show_shapes=True, show_layer_names=True)
    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Results\\model_plot_LSTM_4.png', show_shapes=True, show_layer_names=True)

...
#    checkpointer = ModelCheckpoint(filepath= '\\Weights\\'+dataset_name+'_'+Round+'_'+Linked+'_'+model_variation+'_'+Vectors+'_weights_Ar_best.csv', verbose=1, save_best_only=False)
...
#    history = model.fit(train_sequences, train_labels, validation_data = (test_sequences, test_labels), batch_size=32, nb_epoch=5, verbose=2, callbacks=[early_stopping, checkpointer])

...
#    lay4 = model.add(Dense(output_dim = 100, init = 'uniform', activation = 'relu'))
    ...
    pd.DataFrame(model.fit(train_sequences, train_labels, batch_size = 128, nb_epoch = 50, verbose=1).history).to_csv("C:\\Users\\paperspace\\Desktop\\Results\\history_"+dataset_name+".csv")

...
#    history = model.fit(train_sequences, train_labels, validation_data = (test_sequences, test_labels), batch_size=32, nb_epoch=10, verbose=2, callbacks=[early_stopping, checkpointer])

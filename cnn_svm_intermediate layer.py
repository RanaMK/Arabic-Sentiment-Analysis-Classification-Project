...
#    plot_model(model, to_file='C:\\Users\\paperspace\\Desktop\\Plots\\model_plot.png', show_shapes=True, show_layer_names=True)
    plot_model(model, to_file='E:\\model_plot_cnn.png', show_shapes=True, show_layer_names=True)
    # model compilation
    # ==================================================
...
#    early_stopping = EarlyStopping(patience=20, verbose=1)
    ...
    #without chepointer
#    hist = model.fit(x=train_sequences, y=train_labels, batch_size=32, nb_epoch=5, verbose=2, callbacks= [early_stopping])

...
#        classifier.add(Dense(output_dim = 8, init = 'uniform', activation = 'relu'))
    ...
    def CNN_withEmbed(X_train, Y_train, X_test, Y_test, input_dim):
...
#        print(classifier.summary())
    ...
    def CNN_withoutEmbed( X_train, Y_train, X_test, Y_test, input_dim):
        ##################### Convlutional Neural Networks #####################
        # Encoding categorical data
        from sklearn.preprocessing import LabelEncoder, OneHotEncoder
        labelencoder_Y_train = LabelEncoder()
        ...
        model = Sequential()
        model.add(Dense(50, input_shape=(input_dim,), activation='relu')) 
